...
/** Cursor role — same priority as terminal spec (between ac1=70 and ac2=65) */
...
/**
 * Create a ThemeSpec for the Zed editor.
 *
 * Extends the VSCode spec with a cursor role and cursorText derived color.
 * Zed's integrated terminal, syntax highlighting, and UI share the same
 * palette — so all roles from VSCode are included.
 *
 * Includes:
 ...
 * - selectionBg   — ac2 with hex alpha '50'
 * - selectionFg   — copy of fg1
 * - lineHighlight — ac1 with hex alpha '50'
 * - findMatch     — ac2 with hex alpha '4d'
 ...
 */
export function createZedSpec(options?: ZedSpecOptions): ThemeSpec {
